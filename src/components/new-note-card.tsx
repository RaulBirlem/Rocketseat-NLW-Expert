          ...
          <div className="flex flex-1 flex-col gap-3 p-5">
                  ...
                  <p className="text-sm leading-6 text-slate-400">
                    ...
                    <textarea 
                      ...
                      value={content} /* reflete o valor da variável,quando salvar nota ele reseta o antigo state'content' */
                    />
                  )}
                    ...
                    >
                      <div className="size-3 rounded-full bg-red-500 animate-pulse"/>
                        Gravando áudio (clique para interromper).
                    </button> 
                    ): (
                      <button 
                      type='button'
